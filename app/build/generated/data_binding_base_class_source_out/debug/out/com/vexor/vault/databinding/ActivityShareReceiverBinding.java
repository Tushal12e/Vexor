...
public final class ActivityShareReceiverBinding implements ViewBinding {
  ...
  private ActivityShareReceiverBinding(@NonNull LinearLayout rootView, @NonNull Button btn0,
      ...
      @NonNull Button btn9, @NonNull ImageButton btnCancel, @NonNull ImageButton btnDelete,
  ...
  public static ActivityShareReceiverBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityShareReceiverBinding((LinearLayout) rootView, btn0, btn1, btn2, btn3, btn4,
          btn5, btn6, btn7, btn8, btn9, btnCancel, btnDelete, dot1, dot2, dot3, dot4, tvTitle);
    }
