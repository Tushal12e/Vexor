...
public final class ActivityChangePinBinding implements ViewBinding {
  ...
  private ActivityChangePinBinding(@NonNull LinearLayout rootView, @NonNull Button btn0,
      ...
      @NonNull Button btn9, @NonNull ImageButton btnDelete, @NonNull View dot1, @NonNull View dot2,
      @NonNull View dot3, @NonNull View dot4, @NonNull MaterialToolbar toolbar,
  ...
  public static ActivityChangePinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChangePinBinding((LinearLayout) rootView, btn0, btn1, btn2, btn3, btn4,
          btn5, btn6, btn7, btn8, btn9, btnDelete, dot1, dot2, dot3, dot4, toolbar, tvTitle);
    }
